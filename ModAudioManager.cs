...
namespace R2CustomSounds {
	public class ModAudioManager {
		...
		/// </summary>
		/// <param name="assetBundleName"> Name of the AssetBundle, should be unique among all mods </param>
		/// <param name="directory"> Directory to search for files in </param>
		public static void LoadCustomEvents(string assetBundleName, string directory) {
		...
		public static void PlayOneShot(string sound_event, float volume = 1) {
			...
			CorePlugin.instance.StartCoroutine(playCustomEvent(instance, soundEvent.length));
		}
